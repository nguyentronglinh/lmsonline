    ...
    <div id="page-content" class="row-fluid">
    	<?php if ($hasfrontpageblocks==1) { ?>
            ...
            <div class="row-fluid span12">
                ...
                <section id="region-main" class="span12 pull-right"> <!-- change span8 to span 12 | by Maidt -->
                <?php } else { ?>
                <section id="region-main" class="span12"> <!-- change span8 to span 12 | by Maidt -->
                <?php } ?>
        <?php } else { ?>
